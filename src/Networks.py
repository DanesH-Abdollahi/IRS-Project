...
class CriticNetwork(keras.Model):
    def __init__(self, fc1_dims, fc2_dims, name="Critic", chkpt_dir="../tmp/ddpg"):
        ...
        self.action_value_3 = Dense(256, activation="relu")
...
class ActorNetwork(keras.Model):
    def __init__(
        ...
        if multi_out_layer:
            # self.irs1_0 = Dense(1024, activation="relu")
            ...
            # self.irs2_0 = Dense(1024, activation="relu")
            ...
            # self.w1_0 = Dense(1024, activation="relu")
            ...
            # self.w2_0 = Dense(1024, activation="relu")
